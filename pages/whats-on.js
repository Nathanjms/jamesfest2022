  ...
  return (
    ...
    >
      <div className="card h-100 whatsOnCard">
        ...
        <p className="ps-1 pe-1">{content.text}</p>
      </div>
    </div>
  );
};
...
const whatsOnContent = [
  {
    icon: <MdOutlinePark />,
    text: `Firstly the venue, we think you’ll love it. We chose the river
  ...
  {
    icon: <GiTeapot />,
    text: `After the ceremony, you can relax or take a wander around the
  grounds while enjoying reception drinks, followed closely by
  an afternoon tea in our magical tipi.`,
    fullWidth: false,
  },
  {
    icon: <MdSportsCricket />,
    text: `We have a great afternoon planned for you; a series of musical
  ...
  {
    icon: <FaIceCream />,
    text: `We’ll have an antique ice cream cart on duty throughout the
  afternoon and of course an outdoor bar. In the early evening,
  we will have street food available outside the tipi.`,
    fullWidth: false,
  },
  {
    icon: <FaMusic />,
    text: `We are planning a mammoth communal sing-along around fire-pits
